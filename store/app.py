...
app.config['STORAGE_FOLDER'] = '/home/steve/code/cl/DeepGreen/jperstore'

file_handler = RotatingFileHandler('/home/steve/code/cl/DeepGreen/jperstorelog', maxBytes=10000000, backupCount=5)
